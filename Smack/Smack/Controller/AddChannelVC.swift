...
class AddChannelVC: UIViewController {
    ...
    @IBAction func createChannelPressed(_ sender: Any) {
        ...
        guard let channcelDescription = descriptionTxt.text else { return }
        
        SocketService.instance.addChannel(channelName: channelName , channelDescription: channcelDescription) { (success) in
            if success  {
